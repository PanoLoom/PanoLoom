//! rBRIEF sampling pattern from OpenCV orb.cpp (bit_pattern_31_).
//! 256 comparisons x 2 points x (x, y), patch 31x31. Apache-2.0, see NOTICE.

#[rustfmt::skip]
pub const BIT_PATTERN_31: [i32; 1024] = [
